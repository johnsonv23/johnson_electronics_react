      ...
      <div className="container mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="space-x-4 mt-3 md:mt-0">
            <a href="https://facebook.com" className="hover:text-white"><i className="fa-brands fa-facebook"></i></a>
            <a href="https://twitter.com" className="hover:text-white"><i className="fa-brands fa-twitter"></i></a>
            <a href="https://linkedin.com" className="hover:text-white"><i className="fa-brands fa-linkedin"></i></a>
          </div>
        </div>
      </div>
